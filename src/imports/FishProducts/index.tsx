import svgPaths from "./svg-j0plfn9aht";
import imgCatigory from "./51a9ba6d2ae2d69f119620b730adb5c45c852c50.png";
...
function Product({ className }: { className?: string }) {
  return (
    <div className={className || "absolute bg-[#d9d9d9] gap-x-[6px] grid grid-cols-[__533px_minmax(0,1fr)] grid-rows-[__302px_minmax(0,1fr)] h-[453px] left-[52px] px-[18px] py-[21px] rounded-[24px] top-[540px] w-[1322px]"} data-name="Product">
...
export default function FishProducts() {
  return (
    <div className="bg-white relative size-full" data-name="Fish Products">
      <div className="absolute content-stretch flex flex-col gap-[14px] h-[338px] items-center justify-end left-[-1px] px-[50px] shadow-[4px_4px_4px_0px_rgba(0,0,0,0.25)] top-[133px] w-[1443px]" data-name="Catigory">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgCatigory} />
        <div className="[word-break:break-word] flex flex-col font-['Raleway:Black',sans-serif] font-black justify-center leading-[0] relative shrink-0 text-[60px] text-center text-shadow-[4px_4px_4px_rgba(0,0,0,0.25)] text-white w-full">
          <p className="leading-[1.2]">FISH</p>
        </div>
        <div className="bg-[#004b99] h-[9px] relative rounded-[24px] shrink-0 w-full" />
      </div>
      <Product />
